namespace TeachTheChild.Web.Models
{
    ...
    {
        /// <summary>
        /// The draw counter that this object is a response to - from the draw parameter sent as part
        /// of the data request. Note that it is strongly recommended for security reasons that you
        /// cast this parameter to an integer, rather than simply echoing back to the client what it
        /// sent in the draw parameter, in order to prevent Cross Site Scripting (XSS) attacks.
        /// </summary>
    ...
    public abstract class DTRow
    {
        ...
        /// <summary>
        /// Add this data property to the row's dt-tag tr node allowing abstract data to be added to
        /// the node, using the HTML5 data-* attributes. This uses the jQuery data() method to set
        /// the data, which can also then be used for later retrieval (for example on a click event).
        /// </summary>
    ...
    public class DTParameters
    {
        ...
        /// processing requests are drawn in sequence by DataTables (Ajax requests are asynchronous
        /// and thus can return out of sequence). This is used as part of the draw return parameter
        /// (see below).
        /// </summary>
        public int Draw { get; set; }
        ...
        /// <summary>
        /// An array defining how many columns are being ordering upon - i.e. if the array length is
        /// 1, then a single column sort is being performed, otherwise a multi-column sort is being performed.
        /// </summary>
        public DTOrder[] Order { get; set; }

        /// <summary>
        /// Paging first record indicator. This is the start point in the current data set (0 index
        /// based - i.e. 0 is the first record).
        /// </summary>
        public int Start { get; set; }

        /// <summary>
        /// Number of records that the table can display in the current draw. It is expected that the
        /// number of records returned will be equal to this number, unless the server has fewer
        /// records to return. Note that this can be -1 to indicate that all records should be
    ...
    public class DTColumn
    {
        ...
        /// <summary>
        /// Flag to indicate if this column is searchable (true) or not (false). This is controlled
    ...
    public class DTSearch
    {
        ...
        /// searching, false otherwise. Note that normally server-side processing scripts will not
        /// perform regular expression searching for performance reasons on large data sets, but it
